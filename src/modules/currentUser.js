...
// 데이터관리 방법2
// { userinfo: null, login:false }와 같이 객체 안에 속성으로 추가해서 사용 (*겹쳐지지않게 ...로 들고와 사용)
...
function currentUser ( state=initialState, action ) {
    switch(action.type){
        ...
        // 구글인증을 통해 가져온 값은, 객체를 통해 가져와진다
        // 그 값을 통째로 넣고자 한다면 받아온 값 그대로 넣어주면 된다. 
        // >> 그러나 그대로 넣어주기보단, 그 안의 값들 중 필요한 것만 골라서 넣는 것이 좋다! 
